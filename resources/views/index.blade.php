        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-7">
                    <div class="cv-logo">
                        <a href="index3.html"><img src="{{asset("assets/images/logo-color.svg")}}" alt="image"
                                                   class="img-fluid"/></a>
                    </div>
                </div>
                    ...
                    <div class="cv-nav-bar">
                        ...
                        <div class="cv-head-icon">
                            {{--<ul>
                                ...
                                <li>
                                    <a href="javascript:;" class="cv-head-user" data-bs-toggle="modal"
                    ...
                    <div class="cv-product-box">
                        <div class="cv-product-img">
                            ...
                            <div class="cv-product-button">
                                <a href="product-single.html" class="cv-btn">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="cv-product-box">
                                    <div class="cv-product-img">
                                        <img src="{{asset("assets/images/product2.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                        <div class="cv-product-button">
                                            <a href="product-single.html" class="cv-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                            ...
                            <div class="swiper-slide">
                                <div class="cv-product-box">
                                    <div class="cv-product-img">
                                        <span class="cv-sale">sale</span>
                                        <img src="{{asset("assets/images/product8.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                        <div class="cv-product-button">
                                            <a href="product-single.html" class="cv-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                            ...
                            <div class="swiper-slide">
                                <div class="cv-product-box">
                                    <div class="cv-product-img">
                                        <img src="{{asset("assets/images/product4.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                        <div class="cv-product-button">
                                            <a href="product-single.html" class="cv-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                            ...
                            <div class="swiper-slide">
                                <div class="cv-product-box">
                                    <div class="cv-product-img">
                                        <span class="cv-sale">sale</span>
                                        <img src="{{asset("assets/images/product7.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                        <div class="cv-product-button">
                                            <a href="product-single.html" class="cv-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                        ...
                        <div class="swiper-slide">
                            <div class="cv-testi-box">
                                <div class="cv-testi-data">
                                    <div class="cv-testi-footer">
                                        <div class="cv-testi-img">
                                            <img src="{{asset("assets/images/user2.jpg")}}" alt="image"
                                                 class="img-fluid"/>
                                        </div>
                                        <div class="cv-testi-name">
                                            <h1>John Michel</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="cv-team-box">
                        <div class="cv-team-img">
                            <img src="{{asset("assets/images/team1.jpg")}}" alt="image" class="img-fluid"/>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="cv-team-box">
                        <div class="cv-team-img">
                            <img src="{{asset("assets/images/team2.jpg")}}" alt="image" class="img-fluid"/>
                        </div>
                        <div class="cv-team-text">
                            <ul class="cv-team-social">
                                <li><a href="javascript:;">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="cv-team-box">
                        <div class="cv-team-img">
                            <img src="{{asset("assets/images/team3.jpg")}}" alt="image" class="img-fluid"/>
                        </div>
                        <div class="cv-team-text">
                            <ul class="cv-team-social">
                                <li><a href="javascript:;">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="cv-team-box">
                        <div class="cv-team-img">
                            <img src="{{asset("assets/images/team4.jpg")}}" alt="image" class="img-fluid"/>
                        </div>
                        <div class="cv-team-text">
                            <ul class="cv-team-social">
                                <li><a href="javascript:;">
    ...
    <div class="cv-blog-two cv-blog-three spacer-top-less">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="cv-blog-box">
                        <div class="cv-blog-img">
                            <img src="{{asset("assets/images/blog3.jpg")}}" alt="image" class="img-fluid"/>
                        </div>
                    ...
                    <div class="cv-blog-box">
                        <div class="cv-blog-img">
                            <img src="{{asset("assets/images/blog4.jpg")}}" alt="image" class="img-fluid"/>
                        </div>
                        <div class="cv-blog-data">
                            <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                            <a href="blog-single.html" class="cv-blog-title">Quis nostrud exercitation ullamco</a>
                ...
                <div class="col-lg-6">
                    <div class="cv-blog-widget">
                        <ul>
                            <li>
                                <div class="cv-blog-wid-box">
                                    <div class="cv-blog-wid-img">
                                        <img src="{{asset("assets/images/blog-wid1.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                    </div>
                                    <div class="cv-blog-wid-text">
                                        <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                                        <h2><a href="javascript:;" class="cv-blog-title">Exercitation ullamco laboris
                                                nisi ut</a></h2>
                                        <p>Ut enim ad minim veniam, quis nostrud exercitation nisi laboris ut aliquip ex
                            ...
                            <li>
                                <div class="cv-blog-wid-box">
                                    <div class="cv-blog-wid-img">
                                        <img src="{{asset("assets/images/blog-wid2.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                    </div>
                                    <div class="cv-blog-wid-text">
                                        <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                                        <h2><a href="javascript:;" class="cv-blog-title">Minim nostrud quis
                                                exercitation</a></h2>
                                        <p>Ut enim ad minim veniam, quis nostrud exercitation nisi laboris ut aliquip ex
                                            ea commodo consequat.</p>
                                    </div>
                            ...
                            <li>
                                <div class="cv-blog-wid-box">
                                    <div class="cv-blog-wid-img">
                                        <img src="{{asset("assets/images/blog-wid3.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                    </div>
                                    <div class="cv-blog-wid-text">
                                        <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                                        <h2><a href="javascript:;" class="cv-blog-title">Enim ad minim veniam, quis
                                                nostrud</a></h2>
                                        <p>Ut enim ad minim veniam, quis nostrud exercitation nisi laboris ut aliquip ex
                                            ea commodo consequat.</p>
                                    </div>
                            ...
                            <li>
                                <div class="cv-blog-wid-box">
                                    <div class="cv-blog-wid-img">
                                        <img src="{{asset("assets/images/blog-wid4.jpg")}}" alt="image"
                                             class="img-fluid"/>
                                    </div>
                                    <div class="cv-blog-wid-text">
                                        <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                                        <h2><a href="javascript:;" class="cv-blog-title">Laboris nisi ut aliquip ex ea
                                                commodo</a></h2>
                                        <p>Ut enim ad minim veniam, quis nostrud exercitation nisi laboris ut aliquip ex
                                            ea commodo consequat.</p>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-3 col-6">
                    <div class="cv-instagram-box">
                        <a href="javascript:;">
                            <img src="{{asset("assets/images/insta1.jpg")}}" alt="image" class="img-fluid"/>
                ...
                <div class="col-md-3 col-6">
                    <div class="cv-instagram-box">
                        <a href="javascript:;">
                            <img src="{{asset("assets/images/insta2.jpg")}}" alt="image" class="img-fluid"/>
                            <svg viewBox="0 0 511 511.9" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="m510.949219 150.5c-1.199219-27.199219-5.597657-45.898438-11.898438-62.101562-6.5-17.199219-16.5-32.597657-29.601562-45.398438-12.800781-13-28.300781-23.101562-45.300781-29.5-16.296876-6.300781-34.898438-10.699219-62.097657-11.898438-27.402343-1.300781-36.101562-1.601562-105.601562-1.601562s-78.199219.300781-105.5 1.5c-27.199219 1.199219-45.898438 5.601562-62.097657 11.898438-17.203124 6.5-32.601562 16.5-45.402343 29.601562-13 12.800781-23.097657 28.300781-29.5 45.300781-6.300781 16.300781-10.699219 34.898438-11.898438 62.097657-1.300781 27.402343-1.601562 36.101562-1.601562 105.601562s.300781 78.199219 1.5 105.5c1.199219 27.199219 5.601562 45.898438 11.902343 62.101562 6.5 17.199219 16.597657 32.597657 29.597657 45.398438 12.800781 13 28.300781 23.101562 45.300781 29.5 16.300781 6.300781 34.898438 10.699219 62.101562 11.898438 27.296876 1.203124 36 1.5 105.5 1.5s78.199219-.296876 105.5-1.5c27.199219-1.199219 45.898438-5.597657 62.097657-11.898438 34.402343-13.300781 61.601562-40.5 74.902343-74.898438 6.296876-16.300781 10.699219-34.902343 11.898438-62.101562 1.199219-27.300781 1.5-36 1.5-105.5s-.101562-78.199219-1.300781-105.5zm-46.097657 209c-1.101562 25-5.300781 38.5-8.800781 47.5-8.601562 22.300781-26.300781 40-48.601562 48.601562-9 3.5-22.597657 7.699219-47.5 8.796876-27 1.203124-35.097657 1.5-103.398438 1.5s-76.5-.296876-103.402343-1.5c-25-1.097657-38.5-5.296876-47.5-8.796876-11.097657-4.101562-21.199219-10.601562-29.398438-19.101562-8.5-8.300781-15-18.300781-19.101562-29.398438-3.5-9-7.699219-22.601562-8.796876-47.5-1.203124-27-1.5-35.101562-1.5-103.402343s.296876-76.5 1.5-103.398438c1.097657-25 5.296876-38.5 8.796876-47.5 4.101562-11.101562 10.601562-21.199219 19.203124-29.402343 8.296876-8.5 18.296876-15 29.398438-19.097657 9-3.5 22.601562-7.699219 47.5-8.800781 27-1.199219 35.101562-1.5 103.398438-1.5 68.402343 0 76.5.300781 103.402343 1.5 25 1.101562 38.5 5.300781 47.5 8.800781 11.097657 4.097657 21.199219 10.597657 29.398438 19.097657 8.5 8.300781 15 18.300781 19.101562 29.402343 3.5 9 7.699219 22.597657 8.800781 47.5 1.199219 27 1.5 35.097657 1.5 103.398438s-.300781 76.300781-1.5 103.300781zm0 0"/>
                                <path
                ...
                <div class="col-md-3 col-6">
                    <div class="cv-instagram-box">
                        <a href="javascript:;">
                            <img src="{{asset("assets/images/insta4.jpg")}}" alt="image" class="img-fluid"/>
                            <svg viewBox="0 0 511 511.9" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="m510.949219 150.5c-1.199219-27.199219-5.597657-45.898438-11.898438-62.101562-6.5-17.199219-16.5-32.597657-29.601562-45.398438-12.800781-13-28.300781-23.101562-45.300781-29.5-16.296876-6.300781-34.898438-10.699219-62.097657-11.898438-27.402343-1.300781-36.101562-1.601562-105.601562-1.601562s-78.199219.300781-105.5 1.5c-27.199219 1.199219-45.898438 5.601562-62.097657 11.898438-17.203124 6.5-32.601562 16.5-45.402343 29.601562-13 12.800781-23.097657 28.300781-29.5 45.300781-6.300781 16.300781-10.699219 34.898438-11.898438 62.097657-1.300781 27.402343-1.601562 36.101562-1.601562 105.601562s.300781 78.199219 1.5 105.5c1.199219 27.199219 5.601562 45.898438 11.902343 62.101562 6.5 17.199219 16.597657 32.597657 29.597657 45.398438 12.800781 13 28.300781 23.101562 45.300781 29.5 16.300781 6.300781 34.898438 10.699219 62.101562 11.898438 27.296876 1.203124 36 1.5 105.5 1.5s78.199219-.296876 105.5-1.5c27.199219-1.199219 45.898438-5.597657 62.097657-11.898438 34.402343-13.300781 61.601562-40.5 74.902343-74.898438 6.296876-16.300781 10.699219-34.902343 11.898438-62.101562 1.199219-27.300781 1.5-36 1.5-105.5s-.101562-78.199219-1.300781-105.5zm-46.097657 209c-1.101562 25-5.300781 38.5-8.800781 47.5-8.601562 22.300781-26.300781 40-48.601562 48.601562-9 3.5-22.597657 7.699219-47.5 8.796876-27 1.203124-35.097657 1.5-103.398438 1.5s-76.5-.296876-103.402343-1.5c-25-1.097657-38.5-5.296876-47.5-8.796876-11.097657-4.101562-21.199219-10.601562-29.398438-19.101562-8.5-8.300781-15-18.300781-19.101562-29.398438-3.5-9-7.699219-22.601562-8.796876-47.5-1.203124-27-1.5-35.101562-1.5-103.402343s.296876-76.5 1.5-103.398438c1.097657-25 5.296876-38.5 8.796876-47.5 4.101562-11.101562 10.601562-21.199219 19.203124-29.402343 8.296876-8.5 18.296876-15 29.398438-19.097657 9-3.5 22.601562-7.699219 47.5-8.800781 27-1.199219 35.101562-1.5 103.398438-1.5 68.402343 0 76.5.300781 103.402343 1.5 25 1.101562 38.5 5.300781 47.5 8.800781 11.097657 4.097657 21.199219 10.597657 29.398438 19.097657 8.5 8.300781 15 18.300781 19.101562 29.402343 3.5 9 7.699219 22.597657 8.800781 47.5 1.199219 27 1.5 35.097657 1.5 103.398438s-.300781 76.300781-1.5 103.300781zm0 0"/>
                                <path
                ...
                <div class="col-md-3 col-6">
                    <div class="cv-instagram-box">
                        <a href="javascript:;">
                            <img src="{{asset("assets/images/insta3.jpg")}}" alt="image" class="img-fluid"/>
                            <svg viewBox="0 0 511 511.9" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="m510.949219 150.5c-1.199219-27.199219-5.597657-45.898438-11.898438-62.101562-6.5-17.199219-16.5-32.597657-29.601562-45.398438-12.800781-13-28.300781-23.101562-45.300781-29.5-16.296876-6.300781-34.898438-10.699219-62.097657-11.898438-27.402343-1.300781-36.101562-1.601562-105.601562-1.601562s-78.199219.300781-105.5 1.5c-27.199219 1.199219-45.898438 5.601562-62.097657 11.898438-17.203124 6.5-32.601562 16.5-45.402343 29.601562-13 12.800781-23.097657 28.300781-29.5 45.300781-6.300781 16.300781-10.699219 34.898438-11.898438 62.097657-1.300781 27.402343-1.601562 36.101562-1.601562 105.601562s.300781 78.199219 1.5 105.5c1.199219 27.199219 5.601562 45.898438 11.902343 62.101562 6.5 17.199219 16.597657 32.597657 29.597657 45.398438 12.800781 13 28.300781 23.101562 45.300781 29.5 16.300781 6.300781 34.898438 10.699219 62.101562 11.898438 27.296876 1.203124 36 1.5 105.5 1.5s78.199219-.296876 105.5-1.5c27.199219-1.199219 45.898438-5.597657 62.097657-11.898438 34.402343-13.300781 61.601562-40.5 74.902343-74.898438 6.296876-16.300781 10.699219-34.902343 11.898438-62.101562 1.199219-27.300781 1.5-36 1.5-105.5s-.101562-78.199219-1.300781-105.5zm-46.097657 209c-1.101562 25-5.300781 38.5-8.800781 47.5-8.601562 22.300781-26.300781 40-48.601562 48.601562-9 3.5-22.597657 7.699219-47.5 8.796876-27 1.203124-35.097657 1.5-103.398438 1.5s-76.5-.296876-103.402343-1.5c-25-1.097657-38.5-5.296876-47.5-8.796876-11.097657-4.101562-21.199219-10.601562-29.398438-19.101562-8.5-8.300781-15-18.300781-19.101562-29.398438-3.5-9-7.699219-22.601562-8.796876-47.5-1.203124-27-1.5-35.101562-1.5-103.402343s.296876-76.5 1.5-103.398438c1.097657-25 5.296876-38.5 8.796876-47.5 4.101562-11.101562 10.601562-21.199219 19.203124-29.402343 8.296876-8.5 18.296876-15 29.398438-19.097657 9-3.5 22.601562-7.699219 47.5-8.800781 27-1.199219 35.101562-1.5 103.398438-1.5 68.402343 0 76.5.300781 103.402343 1.5 25 1.101562 38.5 5.300781 47.5 8.800781 11.097657 4.097657 21.199219 10.597657 29.398438 19.097657 8.5 8.300781 15 18.300781 19.101562 29.402343 3.5 9 7.699219 22.597657 8.800781 47.5 1.199219 27 1.5 35.097657 1.5 103.398438s-.300781 76.300781-1.5 103.300781zm0 0"/>
                                <path
            ...
            <div class="row">
                <div class="col-12">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="javascript:;"><img src="{{asset("assets/images/client2.jpg")}}" alt="image"
                                                            class="img-fluid"/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="javascript:;"><img src="{{asset("assets/images/client1.jpg")}}" alt="image"
                                                            class="img-fluid"/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="javascript:;"><img src="{{asset("assets/images/client3.jpg")}}" alt="image"
                                                            class="img-fluid"/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="javascript:;"><img src="{{asset("assets/images/client4.jpg")}}" alt="image"
                                                            class="img-fluid"/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="javascript:;"><img src="{{asset("assets/images/client5.jpg")}}" alt="image"
                                                            class="img-fluid"/></a>
                            </div>
                        </div>
                    </div>
