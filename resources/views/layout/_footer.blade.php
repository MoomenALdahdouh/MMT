        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="cv-foot-box cv-foot-logo">
                    <a href="{{url("/")}}"><img width="320" src="{{asset("assets/admin/images/logo.png")}}" alt="image"
                                                class="img-fluid"/></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cv-foot-box cv-foot-contact">
                    <h2>Contact</h2>
                    <p><span>Contact : </span><a href="tel:+55 456-789-9651">+55 456-789-9651</a></p>
                    <p><span>Email : </span><a href="mailto:support@domian.com">example@medical.com</a></p>
                    <p><span>Address : </span><a href="http://maps.google.com/?q=785 LNCT block street, USA">785
                            LNCT block street, USA</a></p>
                    <ul class="cv-foot-social">
                        ...
                        <li><a href="javascript:;">
                                <svg viewBox="-21 -81 681.33464 681" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="cv-login-box">
                        <div class="cv-login-wlcm-box">
                            <div class="cv-login-wlcm">
                                ...
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#signUpModal"
                                   data-bs-dismiss="modal" aria-label="Close" class="cv-btn">Sign up</a>
                            </div>
                        </div>
                        <div class="cv-login-form">
                            ...
                            <form>
                                ...
                                <a href="javascript:;" class="pa-forgot-password" data-bs-toggle="modal"
                                   data-bs-target="#forgotModal" data-bs-dismiss="modal" aria-label="Close">Forgot
                                    your password?</a>
                    ...
                    <div class="cv-login-box">
                        <div class="cv-login-wlcm-box">
                            <div class="cv-login-wlcm">
                                ...
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#loginModel"
                                   data-bs-dismiss="modal" aria-label="Close" class="cv-btn">Sign in</a>
                            </div>
                        </div>
                        <div class="cv-login-form">
