        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6">
                <div class="cv-foot-box cv-foot-links">
                    ...
                    <ul>
                        <li><a href="javascript">@lang("sts.Services")</a></li>
                        <li><a href="javascript">@lang("sts.Product Gallery")</a></li>
                        <li><a href="javascript">@lang("sts.About Us")</a></li>
                        <li><a href="javascript">@lang("sts.Contact Us")</a></li>
                ...
                <div class="cv-foot-box cv-foot-links">
                    ...
                    <div class="cv-foot-box cv-foot-contact">
                        <p><a target="_blank" href="{{@$follow_us->facebook}}" class="nav-link p-0"><i
                                    style="color:#3cbcff;"   class="fab fa-facebook-f fa-fw"></i> @lang("sts.Facebook") </a></p>
                        <p><a target="_blank" href="{{@$follow_us->instagram}}" class="nav-link p-0"><i
                                    style="color:#3cbcff;"   class="fab fa-instagram fa-fw"></i> @lang("sts.Instagram") </a></p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cv-foot-box cv-foot-contact">
                    ...
                    <p><a href="tel:+55 456-789-9651"><i class="fa fa-map-marker-alt fa-fw" style="color:#3cbcff;"></i> {{@$follow_us->mobile}}</a></p>
                    ...
                    <p><a href="http://maps.google.com/?q=785 LNCT block street, USA"><i class="fa fa-envelope fa-fw"
                                                                                         style="color:#3cbcff;"></i> {{@custom_lang(@$follow_us,"location")}}</a></p>
                </div>
            </div>
        </div>
    </div>
