        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="row gy-5 g-xl-10">
                    <!--begin::Col-->
                    <div class="col-sm-6 col-xl-3 mb-xl-12">
                        <!--begin::Card widget 2-->
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{$products}}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-bold fs-6 text-gray-400">@lang("str.Products")</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-3 mb-xl-12">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{$categories}}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-bold fs-6 text-gray-400">@lang("str.Categories")</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-3 mb-xl-12">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{$services}}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-bold fs-6 text-gray-400">@lang("str.Services")</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-3 mb-xl-12">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{$users}}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-bold fs-6 text-gray-400">@lang("str.Users")</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
