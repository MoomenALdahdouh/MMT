                                    ...
                                    @foreach($role->role_permissions as $role_permission)
                                        @if(!str_contains($role_permission->permission->name,"_"))
                                            <div class="d-flex align-items-center py-2">
                                                <span class="bullet bg-primary me-3"></span>@lang("str.".$role_permission->permission->name)
                                            </div>
                                        @endif
                                    @endforeach
                                </div>
                    ...
                    <div class="flex-lg-row-fluid ms-lg-10">
                        ...
                        <div class="card card-flush mb-6 mb-xl-9">
                            ...
                            <div class="card-header pt-5">
                                <!--begin::Card title-->
                                <div class="card-title">
                                    <h2 class="d-flex align-items-center">@lang("str.Users Assigned")
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0"
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center min-w-100px">@lang("str.Actions")</th>
                                    </tr>
                                    <!--end::Table row-->
                                    </thead>
                                    <!--end::Table head-->
...
@endsection
@section('js')
    <script src="{{ asset('assets/admin/js/roles/list/users.js') }}" defer></script>
    <script src="{{ asset('assets/admin/js/roles/view/update_role.js') }}" defer></script>
@endsection
