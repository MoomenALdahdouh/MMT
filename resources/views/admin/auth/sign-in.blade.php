    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <a href="{{url("/")}}" class="mb-7 text-center">
                ...
                <img alt="Logo" width="60%" src="{{asset('Controllers\Adminlogo.png')}}" class="logo mb-10"/>
            </a>
            <!--end::Logo-->
            <!--begin::Wrapper-->
                ...
                <div class="form w-100" id="kt_sign_in_form">
                    ...
                    <div class="fv-row mb-10">
                        <div class="d-flex flex-stack mb-2">
                            <label class="form-label fw-bolder text-dark fs-6 mb-0">{{__("str.Email").' / '.__("str.Mobile")}}</label>
                        </div>
                        <input type="email" id="email_signin" name="email_signin"
                               placeholder="{{__("str.Enter Here")}}"
                               class="text-start form-control form-control-lg form-control-solid"
                               value="" required autocomplete
                               autofocus/>
                        <strong id="mobile_signin_error" class="errors text-danger"
                                role="alert"></strong>
