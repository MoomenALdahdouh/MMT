...
@section('title', __("str.Edit Service"))
@section('description',  __("str.Edit Service"))
@section('author',  __("str.Edit Service"))
@section('keywords',  __("str.Edit Service"))
@section('copyright',  __("str.Edit Service"))
@section('css')
@endsection
{{--@php
    $lang = config('app.locale');
    $path = asset("uploads/services/".$service->image);
    $type = pathinfo($path, PATHINFO_EXTENSION);
    $data = file_get_contents($path);
    $service_image = 'data:image/' . $type . ';base64,' . base64_encode($data);
@endphp--}}
@section('content')
    <!--begin::Content-->

    <input type="hidden" id="item_id" value="{{$service->id}}">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__("str.Edit Service")}}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{__("str.Edit Service")}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div id="kt_ecommerce_add_service_form" class="form d-flex flex-column flex-lg-row"
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    <div id="uploaded_image" class="image-input-wrapper w-150px h-150px"
                                         style="background-image: url({{asset("uploads/services/".$service->image)}})"></div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div class="rounded-circle bg-success w-15px h-15px {{$service->status ==  1 ? "bg-success": "bg-danger"}}"
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    <option></option>
                                    <option value="published" {{$service->status ==  1 ? "selected": ""}}>{{__("str.Published")}}</option>
                                    <!--                                    <option value="scheduled">Scheduled</option>-->
                                    <option value="unpublished" {{$service->status ==  0 ? "selected": ""}}>{{__("str.Unpublished")}}</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input id="service_name" type="text" name="service_name" class="form-control mb-2"
                                           placeholder="{{__("str.Service name")}}"
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button id="kt_ecommerce_edit_service_submit" class="btn btn-primary">
...
@endsection
@section('js')
    <script src="{{ asset('assets/admin/js/service/edit_service.js') }}" defer></script>
@endsection
