                            ...
                            <div class="card-body pt-0">
                                ...
                                <select id="product_categories" class="form-select mb-2" data-control="select2"
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}">{{$category->getTranslation('name',config('app.locale'))}}</option>
                                    @endforeach
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
...
@section('js')
    ...
    <script src="{{ asset('assets/admin/js/ckeditor.js') }}" defer></script>
    <script src="{{ asset('assets/admin/js/product/create_product.js') }}" defer></script>
@endsection
