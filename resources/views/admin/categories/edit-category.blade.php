...
@section('title', __("str.Edit Category"))
@section('description',  __("str.Edit Category"))
@section('author',  __("str.Edit Category"))
@section('keywords',  __("str.Edit Category"))
@section('copyright',  __("str.Edit Category"))
@section('css')
@endsection
{{--@php
    ...
    $category_image = 'data:image/' . $type . ';base64,' . base64_encode($data);
@endphp--}}
@section('content')
    <!--begin::Content-->
                ...
                <div id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                     ...
                                     style="background-image: url({{assert("assets/media/svg/files/blank-image.svg")}})">
                                ...
                                <!--begin::Description-->
                                <div>
                                    <strong id="category_image_error" class="errors text-danger fs-7"></strong>
                                </div>
                                <div class="required text-muted fs-7">{{__("str.Set the category thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted and size 1M")}}
                                </div>
                                <!--end::Description-->
                            </div>
                            <!--end::Card body-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div class="rounded-circle bg-success w-15px h-15px {{$category->status ==  1 ? "bg-success": "bg-danger"}}"
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    <option></option>
                                    <option value="published" {{$category->status ==  1 ? "selected": ""}}>{{__("str.Published")}}</option>
                                    <!--                                    <option value="scheduled">Scheduled</option>-->
                                    <option value="unpublished" {{$category->status ==  0 ? "selected": ""}}>{{__("str.Unpublished")}}</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">{{__("str.Set the category status.")}}</div>
                                <!--end::Description-->
                                <!--begin::Datepicker-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input id="category_name" type="text" name="category_name" class="form-control mb-2"
                                           placeholder="{{__("str.Category name")}}"
                                           value="{{$category->getTranslation('name', "ar")}}"/>
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    <strong id="category_name_error" class="errors text-danger fs-7"></strong>
                                    <!--end::Error-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__("str.A category name is required and recommended to be unique.")}}</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input id="category_name_en" type="text" name="category_name_en"
                                           class="form-control mb-2"
                                           placeholder="{{__("str.Category name")}}"
                                           value="{{$category->getTranslation('name', "en")}}"/>
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    <strong id="category_name_en_error" class="errors text-danger fs-7"></strong>
                                    <!--end::Error-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__("str.A category name is required and recommended to be unique.")}}</div>
                                    <!--end::Description-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input id="meta_description" type="text" class="form-control mb-2"
                                           ...
                                           value="{{$category->getTranslation('meta_description', "ar")}}"/>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__("str.Set a meta tag description to the category for increased SEO ranking.")}}
                                    </div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <input id="meta_description_en" type="text" class="form-control mb-2"
                                           name="meta_description"
                                           placeholder="{{__("str.Meta tag Description")}}"
                                           value="{{$category->getTranslation('meta_description', "en")}}"/>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__("str.Set a meta tag description to the category for increased SEO ranking.")}}
                                    </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button id="kt_ecommerce_edit_category_submit" class="btn btn-primary">
...
@endsection
@section('js')
    <script src="{{ asset('assets/admin/js/category/edit_category.js') }}" defer></script>
@endsection
