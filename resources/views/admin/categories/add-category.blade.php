...
@section('title', __("str.Add Category"))
@section('description', __("str.Add Category"))
@section('author', __("str.Add Category"))
@section('keywords', __("str.Add Category"))
@section('copyright', __("str.Add Category"))
@section('css')
@endsection
                ...
                <div id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button id="kt_ecommerce_add_category_submit" class="btn btn-primary">
...
@endsection
@section('js')
    <script src="{{ asset('assets/admin/js/category/create_category.js') }}" defer></script>
@endsection
