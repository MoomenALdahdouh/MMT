                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_61de0bdeeaccb" data-allow-clear="true">
                                            <option></option>
                ...
                <div class="d-flex flex-column flex-lg-row">
                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 mb-lg-0">
                        ...
                        <div class="card card-flush mb-0" data-kt-sticky="true" data-kt-sticky-name="inbox-aside-sticky"
                            ...
                            <div class="card-body">
                                <!--begin::Button-->
                                <a href="{{url("/admin/contact-messages/compose")}}"
                                   class="btn btn-primary text-uppercase w-100 mb-10">New Message</a>
                                <!--end::Button-->
                                <!--begin::Menu-->
                                ...
                                <table class="table table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="{{url("/admin/contact-messages/reply/1")}}"
                                        ...
                                        <td>
                                            <div class="text-dark mb-1">
                                                <!--begin::Heading-->
                                                <a href="{{url("/admin/contact-messages/reply/1")}}" class="text-dark">
